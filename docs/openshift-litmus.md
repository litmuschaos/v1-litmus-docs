...
```
oc apply -f https://litmuschaos.github.io/pages/litmus-operator-v1.4.0.yaml
```
...
```
oc apply -f https://hub.litmuschaos.io/api/chaos?file=charts/generic/experiments.yaml -n nginx
```
