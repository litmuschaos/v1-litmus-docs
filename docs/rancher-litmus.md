...
Download `litmus-operator-v1.9.1.yaml` from https://litmuschaos.github.io/litmus/litmus-operator-v1.9.1.yaml.
...
kubectl delete -f https://hub.litmuschaos.io/api/chaos/1.9.1?file=charts/generic/experiments.yaml -n nginx
