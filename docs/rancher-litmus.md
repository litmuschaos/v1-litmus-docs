...
Download `litmus-operator-v1.5.0.yaml` from https://litmuschaos.github.io/pages/litmus-operator-v1.5.0.yaml.
...
kubectl delete -f https://hub.litmuschaos.io/api/chaos/1.5.0?file=charts/generic/experiments.yaml -n nginx
