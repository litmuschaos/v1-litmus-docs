...
- Based on your use case pick one of the choice from here `https://hub.litmuschaos.io/generic/k8-prometheus-k8s-prometheus`
...
[embedmd]:# (https://raw.githubusercontent.com/litmuschaos/chaos-charts/master/charts/generic/k8-prometheus-k8s-prometheus/rbac-admin.yaml yaml)
```yaml
apiVersion: v1
kind: ServiceAccount
metadata:
...
[embedmd]:# (https://raw.githubusercontent.com/litmuschaos/chaos-charts/master/charts/generic/k8-prometheus-k8s-prometheus/engine.yaml yaml)
```yaml
