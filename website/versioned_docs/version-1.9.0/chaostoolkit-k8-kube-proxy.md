---
id: version-1.9.0-Kubernetes-Chaostoolkit-Cluster-kube-proxy
...
- Based on your use case pick one of the choice from here `https://hub.litmuschaos.io/generic/k8-kube-proxy`
...
[embedmd]:# (https://raw.githubusercontent.com/litmuschaos/chaos-charts/master/charts/generic/k8-kube-proxy/rbac-admin.yaml yaml)
```yaml
apiVersion: v1
kind: ServiceAccount
metadata:
...
[embedmd]:# (https://raw.githubusercontent.com/litmuschaos/chaos-charts/master/charts/generic/k8-kube-proxy/engine.yaml yaml)
```yaml
# engine.yaml
