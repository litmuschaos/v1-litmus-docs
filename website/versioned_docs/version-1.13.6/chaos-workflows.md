---
id: version-1.13.6-chaos-workflows
...
### Install the RBAC & experiment CR for litmus
  ...
  & [experiment](https://hub.litmuschaos.io/api/chaos/1.13.7?file=charts/generic/k8-pod-delete/experiment.yaml) manifests instead 
