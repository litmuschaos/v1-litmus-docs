---
id: version-1.13.6-ec2-terminate-by-tag
...
- Ensure that the `ec2-terminate-by-tag` experiment resource is available in the cluster by executing `kubectl get chaosexperiments` in the desired namespace If not, install from [here](https://hub.litmuschaos.io/api/chaos/1.13.7?file=charts/kube-aws/ec2-terminate-by-tag/experiment.yaml)
