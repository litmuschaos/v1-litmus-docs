---
id: version-1.13.6-rancher-litmus
      ...
      spec:
        components:
          env:
            ...
            - name: LIB_IMAGE  
              value: 'litmuschaos/go-runner:1.13.7' 
...
kubectl delete -f https://hub.litmuschaos.io/api/chaos/1.13.6?file=charts/generic/experiments.yaml -n nginx
