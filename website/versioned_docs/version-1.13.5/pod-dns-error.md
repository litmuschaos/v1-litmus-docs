---
id: version-1.13.5-pod-dns-error
...
[embedmd]:# (https://raw.githubusercontent.com/litmuschaos/chaos-charts/1.13.5/charts/generic/pod-dns-error/rbac.yaml yaml)
```yaml
---
apiVersion: v1
kind: ServiceAccount
...
[embedmd]:# (https://raw.githubusercontent.com/litmuschaos/chaos-charts/1.13.5/charts/generic/pod-dns-error/engine.yaml yaml)
```yaml
