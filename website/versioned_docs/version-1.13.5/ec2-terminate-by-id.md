---
id: version-1.13.5-ec2-terminate-by-id
...
- Ensure that the `ec2-terminate-by-id` experiment resource is available in the cluster by executing `kubectl get chaosexperiments` in the desired namespace If not, install from [here](https://hub.litmuschaos.io/api/chaos/1.13.5?file=charts/kube-aws/ec2-terminate-by-id/experiment.yaml)
