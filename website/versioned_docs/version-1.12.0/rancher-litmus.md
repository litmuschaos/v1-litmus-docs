---
id: version-1.12.0-rancher-litmus
...
[embedmd]:# (https://raw.githubusercontent.com/litmuschaos/chaos-charts/v1.12.x/charts/generic/container-kill/rbac_nginx_getstarted.yaml)
```yaml
---
apiVersion: v1
kind: ServiceAccount
...
[embedmd]:# (https://raw.githubusercontent.com/litmuschaos/chaos-charts/v1.12.x/charts/generic/container-kill/engine_nginx_getstarted.yaml yaml)
```yaml
      ...
      spec:
        components:
          env:
            ...
            - name: LIB_IMAGE  
              value: 'litmuschaos/go-runner:1.12.0' 
...
kubectl delete -f https://hub.litmuschaos.io/api/chaos/1.12.0?file=charts/generic/experiments.yaml -n nginx
