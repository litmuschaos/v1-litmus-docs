---
id: version-1.12.0-node-io-stress
...
- Ensure that the `node-io-stress` experiment resource is available in the cluster  by executing                         `kubectl get chaosexperiments` in the desired namespace. If not, install from [here](https://hub.litmuschaos.io/api/chaos/1.12.0?file=charts/generic/node-io-stress/experiment.yaml)
...
[embedmd]:# (https://raw.githubusercontent.com/litmuschaos/chaos-charts/v1.12.x/charts/generic/node-io-stress/rbac.yaml yaml)
```yaml
---
apiVersion: v1
kind: ServiceAccount
...
<table>
  ...
  <tr>
   ...
   <tr>
    ...
    <td> Optional  </td>
    <td> Default to <code>litmuschaos/go-runner:1.12.0<code> </td>
  </tr>
  <tr>
    <td> RAMP_TIME </td>
...
[embedmd]:# (https://raw.githubusercontent.com/litmuschaos/chaos-charts/v1.12.x/charts/generic/node-io-stress/engine.yaml yaml)
```yaml
