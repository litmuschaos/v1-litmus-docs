---
id: version-1.12.0-chaos-workflows
...
### Install the RBAC & experiment CR for litmus
  ...
  ```
  kubectl apply -f https://hub.litmuschaos.io/api/chaos/1.12.0?file=charts/generic/pod-delete/experiment.yaml -n litmus
  ```
  ...
  & [experiment](https://hub.litmuschaos.io/api/chaos/1.12.0?file=charts/generic/k8-pod-delete/experiment.yaml) manifests instead 
