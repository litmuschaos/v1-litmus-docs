---
id: version-1.13.8-openshift-litmus
...
```
oc apply -f https://litmuschaos.github.io/litmus/litmus-operator-v1.13.8.yaml
```
...
```
oc apply -f https://hub.litmuschaos.io/api/chaos/1.13.8?file=charts/generic/experiments.yaml -n nginx
```
...
- For rbac samples corresponding to other experiments such as, say, container-kill, please refer the respective experiment folder in the [chaos-charts](https://github.com/litmuschaos/chaos-charts/tree/v1.13.x/charts/generic/container-kill) repository.
...
```console
oc delete -f https://litmuschaos.github.io/litmus/litmus-operator-v1.13.8.yaml
```
