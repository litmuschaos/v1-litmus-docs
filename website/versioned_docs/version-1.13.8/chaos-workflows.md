---
id: version-1.13.8-chaos-workflows
...
### Install the RBAC & experiment CR for litmus
  ...
  this [rbac](https://github.com/litmuschaos/chaos-charts/tree/v1.13.x/charts/generic/byoc-pod-delete/Cluster/rbac.yaml) 
  & [experiment](https://hub.litmuschaos.io/api/chaos/1.13.8?file=charts/generic/byoc-pod-delete/experiment.yaml) manifests instead 
