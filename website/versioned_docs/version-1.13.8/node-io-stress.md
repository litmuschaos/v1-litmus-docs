---
id: version-1.13.8-node-io-stress
...
- Ensure that the `node-io-stress` experiment resource is available in the cluster  by executing                         `kubectl get chaosexperiments` in the desired namespace. If not, install from [here](https://hub.litmuschaos.io/api/chaos/1.13.8?file=charts/generic/node-io-stress/experiment.yaml)
...
<table>
  ...
  <tr>
   ...
   <tr>
    ...
    <td> Optional  </td>
    <td> Default to <code>litmuschaos/go-runner:1.13.8<code> </td>
  </tr>
  <tr>
    <td> RAMP_TIME </td>
