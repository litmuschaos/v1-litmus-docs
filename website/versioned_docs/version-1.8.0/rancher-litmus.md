...
Download `litmus-operator-v1.8.0.yaml` from https://litmuschaos.github.io/litmus/litmus-operator-v1.8.0.yaml.
...
```
$ kubectl apply -f https://hub.litmuschaos.io/api/chaos/1.8.0?file=charts/generic/experiments.yaml -n nginx
```
...
kubectl delete -f https://hub.litmuschaos.io/api/chaos/1.8.0?file=charts/generic/experiments.yaml -n nginx
