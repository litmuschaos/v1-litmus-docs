...
```
oc apply -f https://litmuschaos.github.io/litmus/litmus-operator-v1.13.3.yaml
```
...
```
oc apply -f https://hub.litmuschaos.io/api/chaos/1.13.3?file=charts/generic/experiments.yaml -n nginx
```
...
```console
oc delete -f https://litmuschaos.github.io/litmus/litmus-operator-v1.13.3.yaml
```
